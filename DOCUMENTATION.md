...
rotating_coil_analyzer/
  ...
  ├── notebooks/          37 analysis notebooks (4 magnets, 7 campaigns)
  └── scripts/            Standalone utility scripts (generate_notebooks.py, nb_helpers.py, etc.)
```
...
### 9.1 Inventory (37 active notebooks)

| Magnet | Campaign | Notebooks | Type |
|--------|----------|-----------|------|
| LEAR MC62 | 2026-02-11 to 17, Mar 4 | 14 | Dipole (m=1), C-shaped, warm |
| LIU BTP8 | 2019-07-17 | 2 | Quadrupole (m=2), golden standard |
| SM18 | 2024-12-04 | 1 | Dipole (m=1), superconducting |
| SPS MBB | 2025-12-12 to 2026-03-06 | 18 | Dipole (m=1), H-type |
...
to regenerate all of them. All generator scripts use `scripts/nb_helpers.py` for
notebook construction (mandatory — prevents encoding bugs and f-string issues).

R&D notebooks for MC62 4 Hz are generated by dedicated scripts:
- `scripts/generate_marusov_nb.py` — Marusov 2D Fourier reconstruction notebook
- `scripts/generate_rd_notebooks.py` — Eddy transfer function notebook
- `scripts/generate_dynamic_eddy_nb.py` — Dynamic eddy correction notebook
